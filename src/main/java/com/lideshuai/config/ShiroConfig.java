...
import com.lideshuai.filter.KickoutSessionFilter;
import com.lideshuai.shiro.RetryLimitHashedCredentialsMatcher;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(
		...
		// 登录成功后要跳转的链接
		shiroFilterFactoryBean.setSuccessUrl("/home1");
		// 未授权时跳转的界面;
...
//		// <!-- authc:所有url都必须认证通过才可以访问; anon:所有url都都可以匿名访问【放行】-->
	 ...
	 */
	@Bean
    public ShiroRealm1 shiroRealm() {
		ShiroRealm1 shiroRealm = new ShiroRealm1();
