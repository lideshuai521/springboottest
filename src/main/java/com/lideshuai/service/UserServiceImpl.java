...
import com.lideshuai.dao.UserMapper;
import com.lideshuai.dao.UserRoleMapper;
import com.lideshuai.entity.UserDTO;
...
import com.lideshuai.shiro.ShiroRealm1;
import com.lideshuai.utils.DateUtil;
import com.lideshuai.utils.PageDataResult;
import com.lideshuai.utils.SendMsgServer;
...
public class UserServiceImpl implements UserService {
	...
	public PageDataResult getUsers(UserSearchDTO userSearch, int page, int limit) {
		...
		//Map<String,Map<String,Object>> map = userMapper.findUserList();
		return pdr;
	}
	...
	public String setUser(User user, String roleIds) {
		...
		if (user.getId() != null) {
			...
			RealmSecurityManager rsm = (RealmSecurityManager) SecurityUtils
					.getSecurityManager();
			ShiroRealm1 authRealm = (ShiroRealm1) rsm.getRealms().iterator()
					.next();
